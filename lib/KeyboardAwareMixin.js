...
const KeyboardAwareMixin: Object = {
  mixins: [TimerMixin],
  propTypes: {
  ...
  scrollToFocusedInput: function (reactNode: Object, extraHeight: ?number) {
    ...
    this.setTimeout(() => {
      scrollView.scrollResponderScrollNativeHandleToKeyboard(
        reactNode, extraHeight || this.props.extraHeight, true
      )
  ...
  scrollToFocusedInputWithNodeHandle: function (nodeID: number, extraHeight: ?number) {
    ...
    this.scrollToFocusedInput(reactNode, extraHeight || this.props.extraHeight)
  },
